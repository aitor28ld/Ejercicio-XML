...
op = int(raw_input("\nElige una opción de las indicadas arriba: "))
...
#Ejercicio 4
if op == 4:
	camping = raw_input("\nEscribe el nombre de un camping: ")
	campings = raiz.findall("objRegistral")
	for x in campings:
		if camping == x.find("dades_generals/retol").text:
			...
			print "\nhttp://www.openstreetmap.org/way/109089302#map=15/"+medidas[0][1:]+"/"+medidas[1][1:-1]
			
#Ejercicio 5
if op == 5:
	cod = raw_input("\nEscribe el código postal de un camping: ")
